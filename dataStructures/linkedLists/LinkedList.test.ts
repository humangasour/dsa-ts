...
describe("LinkedList", () => {
  ...
  describe("append", () => {
    it("should increase list size by 1 after append", () => {
      ...
      expect(list.toArray()).toEqual([10, 15]);
    });
  });
  ...
  describe("insert", () => {
    ...
    it("should throw error for negative index", () => {
      expect(() => list.insert(-1, 100)).toThrow("Index cannot be negative.");
    });
  });
  ...
  describe("toArray", () => {
    it("should convert list to array", () => {
      list.append(15);
      list.append(25);
      expect(list.toArray()).toEqual([10, 15, 25]);
    });
  });
  ...
  describe("reverse", () => {
    it("should reverse the list with multiple nodes", () => {
      ...
      expect(list.toString()).toBe("4 => 3 => 2 => 1 => null");
